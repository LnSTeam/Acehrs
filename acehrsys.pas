...
//*Verison:v5.0                     *
//*Programming Code:colorful wind   *
//*Program Lines(Info In):374 lines *
//*Programing Ver List:             *
//* dev1.3.5                        *
//*Programing By L&S Team.          *
//***********************************
uses crt,dos; //5.0Add. The colorful UI and beep.
...
begin
 ...
 writeln(' Copyright 2008-2012 L&S Team [OpenSource][Freeware]');
 writeln(' 2012-8-29');
 log('Help');//2.4Add
 command('');
end;
...
begin
 ...
 writeln(' Copyright 2008-2012 L&S Team');
 writeln(' ACE Hotel Rooms System:');
 writeln('  Version 5.0');
 writeln('  Coding Code:colorful wind');
 ...
 writeln(' Developers:');
 writeln('  Pater Lv (paterlv@lnsteam.it.tc) System Kernel Design & Coder');
 writeln('  Cao Yani (374644153@qq.com) System Tester');
 writeln('  Mike Zhuo (mikezhuo@lnsteam.it.tc) System Main Developer & Captain of team');
 writeln('  Ted Zhang (tedzhang@lnsteam.it.tc) System Main Developer');
 writeln(' Press Enter to go on...');
 readln;
 writeln(' E-mails:');
 writeln('  lvshibo@gmail.com (Pater Lv)');
 writeln('  aceworkshop@foxmail.com (Team)');
 writeln('  proj_acehrsys@lnsteam.it.tc (Project)');
 writeln(' Web Pages:');
 writeln('  http://acehrs.sf.net/ (Thanks SourceForge.net)');
 writeln('  http://lvshibo.t.sohu.com/ (Pater Lv)(Chinese)');
 writeln('  http://www.licc.it.tc/');
 writeln('  http://www.lnsteam.it.tc/');
 writeln(' Blogs:');
 writeln('  http://lyqqteam.blog.com/');
 writeln(' Source Code:');
...
begin
 ...
 writeln(' ===Rooms List(',beginp,' to ',endp,') V5.0===');
...
begin
 ...
 close(reco);
 textbackground(black); //5.0b8Add, restore the console's color.
 textcolor(white);
 halt;
end;
...
begin//Main program has a big edit at 2.2 verison.
 ...
 textcolor(white);
 sound(3000);
 writeln(' ===ACE Hotel Rooms System English Version V5.0.0 Build0094===');
